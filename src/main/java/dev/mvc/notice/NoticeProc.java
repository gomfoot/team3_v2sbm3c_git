...
public class NoticeProc implements NoticeProcInter {
  ...
  public int search_count() {
    int count = noticeDAO.search_count();
    return count;
  }
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public List<NoticeVO> list_notice_paging(HashMap<String, Object> map) {
    ...
    */
    ...
    List<NoticeVO> list = this.noticeDAO.list_notice_paging(map);
    ...
    for (NoticeVO NoticeVO : list) { // 내용이 160자 이상이면 160자만 선택
      ...
      //String title = Tool.convertChar(NoticeVO.gettitle());
      //NoticeVO.setTitle(title);
  ...
  public int delete(int contentsno) {
    int cnt = this.noticeDAO.delete(contentsno);
    return cnt;
  }
