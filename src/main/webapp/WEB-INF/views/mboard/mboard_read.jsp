...
--------------------댓글---------------------------------------
  <div>
    <c:forEach var="mboard_replyVO" items="${reply_list }">
        ...
        <c:set var="id" value="${mboard_replyVO.id }" />
      <li>
        <p>
        회원ID : ${mboard_replyVO.id}<br />
...
<DIV>
  <!-- 신규 등록 -->
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #000000; width: 100%; text-align: left;'>
